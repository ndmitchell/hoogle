...
header :: String -> String -> String -> String -> IO String
header css js resources query = return $ ""
...
parseError :: String -> String -> IO String
parseError errFormat errMessage = return $ ""
  ++ "<h1>"
  ++ errFormat
  ++ "</h1>\n<p>\n\t<b>Parse error:</b> "
  ++& errMessage
